import annotator, { util } from 'annotator';
...
export function debug() {
  ...
  return {
    ...
    configure(registry: annotator.registry.Registry) {
...
export class HttpStorage implements annotator.storage.IAnnotationStorage {
   ...
   */
  static options: annotator.storage.IHttpStorageOptions = {
    /**
   ...
   */
  static methodFor(action: string): string {
  ...
  options: annotator.storage.IHttpStorageOptions;
  onError?: (msg: string, xhr: any) => any;

  constructor(options: annotator.storage.IHttpStorageOptions) {
   ...
   * :rtype: Promise
   */
  create(annotation: any): annotator.storage.IAnnotationXHR {
    return this.apiRequest('create', annotation);
  }
   ...
   * :rtype: Promise
   */
  update(annotation: any): annotator.storage.IAnnotationXHR {
    return this.apiRequest('update', annotation);
  }
   ...
   * :rtype: Promise
   */
  delete(annotation: any): annotator.storage.IAnnotationXHR {
    return this.apiRequest('destroy', annotation);
  }
   ...
   */
  query(queryObj: any): {} {
    return this.apiRequest('search', queryObj)
      .then((obj: any) => {
        const rows = obj.rows;
        delete obj.rows;
   ...
   * :rtype: jqXHR
   */
  apiRequest(action: string, obj: any): annotator.storage.IAnnotationXHR {
    const id = obj && obj.id;
    const url = this.urlFor(action, id);
    const options = this.apiRequestOptions(action, obj);
   ...
   * :rtype: Object
   */
  apiRequestOptions(action: string, obj: any) {
    const method = HttpStorage.methodFor(action);
   ...
   */
  urlFor(action: string, id: string | number): string {
   ...
   */
  _onError(xhr: annotator.storage.IAnnotationXHR) {
 ...
 */
export function http(options: annotator.storage.IHttpStorageOptions) {
  ...
  options.onError = options.onError || function onError(msg: string, xhr: any) {
